...
import NotificationsFirebase from '../firebase/Notifications';
...
export default class Notifications extends Component {
    ...
    componentDidMount() {
        NotificationsStorage.getNotifications().then(notifications => {
            this.notificationsUpdated(notifications);
        });
        NotificationsFirebase.setListenerFunction(this.notificationsUpdated);
    }
